...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    SGPIO_Low(&SGPIO_CODEC_RST);
    HAL_I2SEx_TransmitReceive_DMA(&hi2s2, DSP_TxRawBuf, DSP_RxRawBuf, ARRAY_CNT(DSP_TxRawBuf));
    HAL_Delay(400);

    SGPIO_High(&SGPIO_CODEC_RST);
    HAL_Delay(20);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LCD_RST_Pin|CODEC_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ROT_B_Pin ROT_A_Pin ROT_SW_Pin */
  GPIO_InitStruct.Pin = ROT_B_Pin|ROT_A_Pin|ROT_SW_Pin;
